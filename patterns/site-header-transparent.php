<?php
/**
 * Title: Site header (transparent)
 * Slug: yith-wonder/site-header-transparent
 * Categories: yith-wonder-site-header
 * Block Types: core/site-title, core/site-logo, core/navigation
 * Keywords: site header
 * Description: A transparent left aligned site header with horizontal stacked elements: site logo, title, tagline and navigation block. WooCommerce mini cart display when plugin is enabled.
 *
 * @package yith-wonder
 * @since 2.1.0
 */
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--40)","bottom":"var(--wp--preset--spacing--40)"}}},"textColor":"header-foreground","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull has-header-foreground-color has-text-color" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
