...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:35%"><!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
<h2 style="font-style:normal;font-weight:400"><?php echo esc_html_x( 'Engagement Rings', 'demo-contents', 'yith-wonder' ); ?></h2>
<!-- /wp:heading -->
...
<p style="font-style:normal;font-weight:400"><?php echo wp_kses_post( _x( 'Lorem ipsum dolor sit amet, consectetur adispising elit.<br>Vestibulum varius, mi ut posuere iaculis, orci risus consequat urna, faucibus laoreet nunc just a quam.', 'demo-contents', 'yith-wonder' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
