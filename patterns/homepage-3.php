...
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"tertiary","textColor":"base","style":{"border":{"radius":"15px"},"spacing":{"padding":{"top":"20px","right":"30px","bottom":"20px","left":"30px"}}},"className":"is-style-fill","fontSize":"normal"} -->
<div class="wp-block-button has-custom-font-size is-style-fill has-normal-font-size"><a class="wp-block-button__link has-base-color has-tertiary-background-color has-text-color has-background" href="#" style="border-radius:15px;padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px"><?php echo wp_kses_post( _x( '<strong>The Newborn Winter<br>Collection ⟶</strong>', 'demo-contents', 'yith-wonder' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group --></div></div>
...
<div class="wp-block-buttons"><!-- wp:button {"textColor":"base","style":{"border":{"radius":"15px"},"spacing":{"padding":{"top":"20px","right":"30px","bottom":"20px","left":"30px"}},"color":{"background":"#303f67"}},"fontSize":"normal"} -->
<div class="wp-block-button has-custom-font-size has-normal-font-size"><a class="wp-block-button__link has-base-color has-text-color has-background" href="#" style="border-radius:15px;background-color:#303f67;padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px"><?php echo wp_kses_post( _x( '<strong>Maternity and pregnancy </strong><br><strong>clothing ⟶</strong>', 'demo-contents', 'yith-wonder' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column -->
...
<div class="wp-block-buttons"><!-- wp:button {"textColor":"base","style":{"border":{"radius":"15px"},"spacing":{"padding":{"top":"20px","right":"30px","bottom":"20px","left":"30px"}},"color":{"background":"#d8953c"}},"fontSize":"normal"} -->
<div class="wp-block-button has-custom-font-size has-normal-font-size"><a class="wp-block-button__link has-base-color has-text-color has-background" href="#" style="border-radius:15px;background-color:#d8953c;padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px"><?php echo wp_kses_post( _x( '<strong>Sailor &amp; sea inspired for<br>Winter Collection ⟶</strong>', 'demo-contents', 'yith-wonder' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column --></div>
